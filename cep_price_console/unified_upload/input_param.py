...
class FileSelection(Step):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.file_selection_hdr = ttk.Label(self.frame_main)  # TODO: Optimize config statement
        ...
        self.header_row_lbl = ttk.Label(self.header_row_frame)  # TODO: Optimize config statement
        ...
        self.header_row_entry = ttk.Entry(self.header_row_frame)  # TODO: Optimize config statement
        ...
        self.param_frame = ttk.Frame(self.frame_main)  # TODO: Optimize config statement
        ...
        self.param_header = ttk.Label(self.param_frame)  # TODO: Optimize config statement
        ...
        self.param_inst = ttk.Label(self.param_frame)  # TODO: Optimize config statement
        ...
        self.all_prim_chk_box = ttk.Checkbutton(self.param_frame)  # TODO: Optimize config statement
        ...
        self.all_vend_chk_box = ttk.Checkbutton(self.param_frame)  # TODO: Optimize config statement
        ...
        self.param_add_btn = ttk.Button(self.param_frame)  # TODO: Optimize config statement
